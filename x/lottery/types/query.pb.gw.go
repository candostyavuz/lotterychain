...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"lotterychain", "lottery", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Participant_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"lotterychain", "lottery", "participant", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ParticipantAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"lotterychain", "lottery", "participant"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Lottery_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1}, []string{"lotterychain", "lottery"}, "", runtime.AssumeColonVerbOpt(true)))
)
